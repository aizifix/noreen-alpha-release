...
export default function EventsPage() {
  ...
  useEffect(() => {
    try {
      ...
      if (
        !userData ||
        !userData.user_role ||
        !["staff"].includes(userData.user_role.toLowerCase())
      ) {
  ...
  const fetchEvents = async () => {
    try {
      ...
      if (response.data.status === "success") {
        ...
        console.log("Events fetched from staff API:", events.length, "events");
        console.log(
  ...
  const getProfileImageUrl = (pfpPath?: string) => {
    ...
    const baseUrl =
      process.env.NEXT_PUBLIC_API_URL ||
      "https://noreen-events.online/noreen-events";
    const url = `${baseUrl}/serve-image.php?path=${encodeURIComponent(pfpPath)}`;
              ...
              return (
                <div
                  ...
                  onClick={(e) => {
                    ...
                    router.push(`/staff/events/${event.event_id}`);
                  }}
                >
            ...
            {dayEvents.map((event, index) => {
              ...
              return (
                <div
                  ...
                  onClick={() => router.push(`/staff/events/${event.event_id}`)}
                >
              ...
              >
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      router.push(`/staff/events/${event.event_id}/timeline`);
                    }}
                  >
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      router.push(`/staff/payments?event_id=${event.event_id}`);
                    }}
                  >
                    <span>💳</span> Payments
                  </button>
