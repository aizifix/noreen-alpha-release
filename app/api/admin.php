...
class Admin {
    ...
    public function __construct($pdo) {
        ...
        // $this->logger = new ActivityLogger($pdo); // DISABLED TO PREVENT CONCAT COLLATION ERRORS
        $this->logger = null; // Disable activity logging to prevent collation issues
    }
...
try {
    ...
    case "createClient":
        ...
        echo $admin->createClient($clientData);
        break;
    case "getAllEvents":
    ...
    case "describeWeddingTable":
        echo $admin->describeWeddingTable();
        break;
    case "testWeddingInsert":
        echo $admin->testWeddingInsert();
        break;
    ...
    case "updateEventOrganizer":
        ...
        echo $admin->updateEventOrganizer($eventId, $organizerId);
        break;
    ...
    case "syncOrganizerAssignments":
        echo $admin->syncOrganizerAssignments();
        break;
