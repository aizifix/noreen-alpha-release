...
--
-- Host: localhost:3306
-- Generation Time: Oct 04, 2025 at 03:26 AM
...
-- Procedures
--
CREATE DEFINER=`cpses_no09quere2`@`localhost` PROCEDURE `AssignOrganizerToEvent` (IN `p_event_id` INT, IN `p_organizer_id` INT, IN `p_assigned_by` INT, IN `p_notes` TEXT)   BEGIN
...
CREATE DEFINER=`cpses_no09quere2`@`localhost` PROCEDURE `CheckOrganizerDateConflict` (IN `p_organizer_id` INT, IN `p_event_date` DATE, IN `p_event_id` INT, OUT `p_has_conflict` BOOLEAN, OUT `p_conflict_message` TEXT)   BEGIN
...
CREATE DEFINER=`cpses_no09quere2`@`localhost` PROCEDURE `CleanupExpiredNotifications` ()   BEGIN
...
CREATE DEFINER=`cpses_no09quere2`@`localhost` PROCEDURE `CreatePaymentDueNotifications` ()   BEGIN
...
CREATE DEFINER=`cpses_no09quere2`@`localhost` PROCEDURE `GetEventOrganizerDetails` (IN `p_event_id` INT)   BEGIN
    SELECT
        e.event_id,
        e.event_title,
        e.organizer_id,
...
CREATE DEFINER=`cpses_no09quere2`@`localhost` PROCEDURE `GetOrganizerEvents` (IN `p_organizer_id` INT)   BEGIN
    SELECT
        e.event_id,
        e.event_title,
        e.event_date,
...
CREATE DEFINER=`cpses_no09quere2`@`localhost` PROCEDURE `UpdateOrganizerAssignmentStatus` (IN `p_assignment_id` INT, IN `p_status` ENUM('assigned','accepted','rejected','removed'), IN `p_updated_by` INT)   BEGIN
...
(0, 20, 70, NULL, NULL, NULL, NULL, NULL, 'The inclusion Test payment status is now paid.', '', 'Inclusion Payment Status Updated', 'medium', 'credit-card', '/client/events/70', '2025-09-29 01:51:43', '2025-09-27 13:30:17', 'read', '2025-09-22 07:51:43'),
(0, 20, 70, NULL, NULL, NULL, NULL, NULL, 'The inclusion Demiren Hotel payment status is now paid.', '', 'Inclusion Payment Status Updated', 'medium', 'credit-card', '/client/events/70', '2025-09-29 02:05:22', '2025-09-27 13:30:17', 'read', '2025-09-22 08:05:22'),
...
(0, 20, 71, 1, NULL, NULL, NULL, NULL, 'Your event \"Jesse All-in Package Wedding\" has been created successfully! Check your payment schedule for upcoming payments.', 'event_created', 'Event Created Successfully', 'high', 'calendar-check', '/client/events/71', '0000-00-00 00:00:00', '2025-09-27 13:30:17', 'read', '2025-09-24 13:03:19'),
(0, 20, 71, 1, NULL, NULL, NULL, NULL, 'Your event \"Jesse All-in Package Wedding\" has been created successfully! Check your payment schedule for upcoming payments.', 'event_created', 'Event Created Successfully', 'high', 'calendar-check', '/client/events/71', '0000-00-00 00:00:00', '2025-09-27 13:30:17', 'read', '2025-09-24 13:03:19'),
...
(0, 20, 71, NULL, NULL, NULL, NULL, NULL, 'Your payment of ₱270,000.00 for \"your event\" has been submitted and is pending admin confirmation.', 'payment_created', 'Payment Submitted', 'medium', 'credit-card', '/client/payments/64', '0000-00-00 00:00:00', '2025-09-27 13:30:17', 'read', '2025-09-24 13:03:19'),
(0, 7, 71, NULL, NULL, NULL, NULL, NULL, 'New payment of ₱270,000.00 received for \"event\" requiring confirmation.', 'payment_created', 'New Payment Received', 'high', 'dollar-sign', '/admin/payments/64', '0000-00-00 00:00:00', '2025-09-24 15:12:06', 'read', '2025-09-24 13:03:19'),
(0, 7, 1, NULL, NULL, NULL, NULL, NULL, 'Boss Zata has rejected the assignment for event \"AAA Type of wedding v5\".', '', 'Organizer responded to assignment', 'high', 'user-x', '/admin/events/1', NULL, '2025-09-24 15:12:06', 'read', '2025-09-24 15:00:38'),
...
(0, 7, 71, NULL, NULL, NULL, NULL, NULL, 'Rendon Labrabis has rejected the assignment for event \"Jesse All-in Package Wedding\".', '', 'Organizer responded to assignment', 'high', 'user-x', '/admin/events/71', NULL, '2025-09-25 01:02:55', 'read', '2025-09-24 15:18:59'),
(0, 7, 69, NULL, NULL, NULL, NULL, NULL, 'Rendon Labrabis has accepted the assignment for event \"test_test\".', '', 'Organizer responded to assignment', 'high', 'user-check', '/admin/events/69', NULL, '2025-09-25 01:02:55', 'read', '2025-09-24 15:41:37'),
...
(64, 71, NULL, 20, 'cash', 270000.00, 'Initial down payment for event creation', NULL, 'completed', '2025-09-24', NULL, '2025-09-24 13:03:19', '2025-09-24 13:03:19', '[{\"file_name\":\"1758718978_68d3ec0232d81.pdf\",\"original_name\":\"namecheap-order-181570622.pdf\",\"file_path\":\"uploads\\/payment_proofs\\/1758718978_68d3ec0232d81.pdf\",\"file_size\":15972,\"file_type\":\"application\\/pdf\",\"description\":\"Payment proof for cash payment\",\"proof_type\":\"receipt\",\"uploaded_at\":\"2025-09-24 15:03:19\"}]');
...
(7, 'Mayette', 'Lagdamin', '', '1995-12-12', 'aizsingidas@gmail.com', '099909009', 'admin', '$2y$10$/kqcsB6g/loADYG7FIi09ufxRzrU7xF19ap7MpF0DibA77vmVhPAS', 0, '2025-10-04 03:22:43', 'active', 'uploads/profile_pictures/profile_7_1758897499.jpg', 'admin', 1, NULL, '2025-02-25 16:41:22'),
(20, 'Jesse', 'Morcillos', '', '2000-01-09', 'projectlikha.archives@gmail.com', '09054135594', 'jessemorcillos', '$2y$10$A.P0FYybx2WtUt7ai7Ro/OYYLLhSlAGNWiVN/E.6fAF/wnHn4KdG6', 0, '2025-10-02 23:27:56', 'active', 'uploads/profile_pictures/profile_20_1752461113.jpg', 'client', 1, NULL, '2025-07-09 12:04:49'),
...
(28, 'Rendon', 'Labrabis', NULL, '1995-12-12', 'rendon@gmail.com', '+63 63 905 190 3994', 'rendon.labrabis', '$2y$10$5gfBKZ1ZevsTrvtUJ8nmVe53K4jQVorO1o4fkjN9RYV6ZtrICAMze', 0, '2025-09-24 22:59:40', 'active', 'uploads/profile_pictures/profile_28_1757549853.jpg', 'organizer', 1, NULL, '2025-07-16 18:31:57'),
...
(37, 'Frank', 'Polynomyals', NULL, '1999-10-12', 'polynomials@gmail.com', '+639595885994', 'polynomials', '$2y$10$TxP8Cg7oERaMXtKf.m45p.0GapEcBXQfwbs5vtIS804zrasv//Ara', 0, '2025-10-03 21:02:20', 'active', 'uploads/profile_pictures/profile_37_1758978804.jpg', 'client', 1, '2025-09-27 20:01:33', '2025-09-27 12:00:54'),
...
(1, 'Event Coordination System', '', '', '#059669', '#059669', '', '', '', '', '', '', '', 0, '2025-06-26 05:19:02', '2025-09-27 13:15:09');
...
--
ALTER TABLE `tbl_events`
  MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
ALTER TABLE `tbl_event_components`
  MODIFY `component_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=660;
