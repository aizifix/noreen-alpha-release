                ...
                className={`h-8 sm:h-10 flex items-center justify-center text-xs sm:text-sm cursor-pointer rounded-md transition-colors ${
                  isToday
                    ...
                    : isSelected
                      ...
                      : "hover:bg-gray-100"
                } ${dayEvents.length > 0 ? "border-2 border-green-400" : ""}`}
            ...
            {getEventsForDate(selectedDate).length > 0 ? (
              <div className="space-y-2">
                {getEventsForDate(selectedDate).map((event) => (
                  <div
                    key={event.event_id}
                    className="text-sm p-2 bg-white rounded border-l-4 border-brand-500"
                  >
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 gap-4">
          ...
          <Button
            ...
            className="bg-brand-500 hover:bg-brand-600 text-white px-4 sm:px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 w-full sm:w-auto"
          >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 mt-4">
                    <Button
                      ...
                      className="flex-1 border-brand-200 text-brand-600 hover:bg-brand-50 min-h-[10px] text-xm font-medium px-6 py-2 text-teal-600"
                    ...
                    <Button
                      ...
                      className="flex-1 bg-brand-500 hover:bg-brand-600 text-white min-h-[10px] text-xm font-medium px-6 py-2 text-white"
                    >
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto">
                {events
                  ...
                  .map((event) => (
                    <div
                      key={event.event_id}
                      className="p-3 sm:p-4 bg-white rounded-lg border hover:shadow-md transition-shadow cursor-pointer"
              ...
              <div className="space-y-4">
                {upcomingPayments.slice(0, 5).map((payment) => (
                  <div
                    ...
                    className="p-3 sm:p-4 bg-white rounded-lg border hover:shadow-md transition-shadow"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-2">
                      <h4 className="font-medium text-gray-900">
                        {payment.event_title}
                          ...
                          {selectedPackage.event_type_names.map(
                            (eventType, idx) => (
                              <Badge
                                key={idx}
                                variant="secondary"
                                className="bg-brand-100 text-brand-800 px-3 py-1 text-sm"
                              >
                                {eventType}
                              </Badge>
                            )
                              ...
                              selectedPackage.venue_previews.length > 1 && (
                                <>
                                  <button
                                    ...
                                    className={`absolute top-1/2 left-2 transform -translate-y-1/2 p-2 rounded-full bg-white/80 backdrop-blur-sm shadow-md transition-opacity ${
                                      currentVenueIndex === 0
                                  ...
                                  <button
                                    ...
                                    className={`absolute top-1/2 right-2 transform -translate-y-1/2 p-2 rounded-full bg-white/80 backdrop-blur-sm shadow-md transition-opacity ${
                                      currentVenueIndex ===
                                      (selectedPackage?.venue_previews
                                        ?.length ?? 1) -
                                        1
          ...
          <div className="border-t bg-white p-4">
            <div className="flex flex-col sm:flex-row justify-end items-center gap-3">
              ...
              <Button
                ...
                className="w-full sm:w-auto bg-brand-500 hover:bg-brand-600 text-white order-1 sm:order-2"
              >
