...
import { MapPin, Users, Star, Check, Loader2, Eye, X, Phone, Mail, Calendar } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      {!loading && !error && venues && venues.length > 0 && (
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {(showAllVenues ? venues : venues.slice(0, maxVisibleVenues)).map((venue) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <Image
                      src={getImageUrl(venue.venue_cover_photo || venue.venue_profile_picture)}
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-center text-gray-600 text-sm">
                        ...
                        <span>
                          {hasPaxRate ? (
                            <>
                              Base: ₱{venue.venue_price?.toLocaleString() || 0} (up to {venue.base_capacity || 100} guests)
                              <br />
                              Extra: ₱{venue.extra_pax_rate.toLocaleString()}/pax
                            </>
                          ) : (
            ...
            <div className="text-center mt-8">
              ...
              >
                {showAllVenues ? (
                  ...
                  <>
                    <span>See More ({venues.length - maxVisibleVenues} more venues)</span>
      ...
      {!loading && !error && (!venues || venues.length === 0) && (
        <div className="text-center py-16">
          ...
          <p className="text-gray-600">Please add venues to the system before creating packages.</p>
        </div>
      )}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative h-64 rounded-lg overflow-hidden">
                    <Image
                      src={getImageUrl(selectedVenueForDetails.venue_cover_photo || selectedVenueForDetails.venue_profile_picture)}
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-gray-200">
                      <Image
                        src={getImageUrl(selectedVenueForDetails.venue_profile_picture)}
                        alt={selectedVenueForDetails.venue_title}
                        width={80}
                        height={80}
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center text-gray-600">
                        ...
                        <span>Capacity: Up to {selectedVenueForDetails.venue_capacity} guests</span>
                      </div>
                      <div className="flex items-center text-gray-600">
                      ...
                      {selectedVenueForDetails.extra_pax_rate > 0 ? (
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-gray-600">Base Price (up to {selectedVenueForDetails.base_capacity || 100} guests):</span>
                            <span className="font-semibold">₱{selectedVenueForDetails.venue_price?.toLocaleString() || 0}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-gray-600">Extra guest rate:</span>
                            <span className="font-semibold text-green-600">₱{selectedVenueForDetails.extra_pax_rate.toLocaleString()}/pax</span>
                          </div>
                          <div className="border-t border-gray-200 pt-2">
                            <div className="flex justify-between items-center">
                              <span className="text-gray-600">Estimated cost for {guestCount} guests:</span>
                              <span className="font-bold text-lg text-green-600">
                                ₱{calculateVenueCost(selectedVenueForDetails).toLocaleString()}
                              </span>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="flex space-x-3 pt-4">
                    <button
                      ...
                      className={`flex-1 py-3 px-4 rounded-lg font-medium transition-colors ${
                        selectedVenueIds.includes(selectedVenueForDetails.venue_id)
                          ? "bg-red-50 text-red-700 border border-red-200 hover:bg-red-100"
                          : "bg-green-50 text-green-700 border border-green-200 hover:bg-green-100"
                      }`}
                    >
                      {selectedVenueIds.includes(selectedVenueForDetails.venue_id) ? "Remove from Package" : "Add to Package"}
                    </button>
                    <button
                      onClick={() => setSelectedVenueForDetails(null)}
